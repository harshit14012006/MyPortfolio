...
import AOS from 'aos';
import { FaExternalLinkAlt, FaGithub, FaFileCode, FaLinkedin , FaEnvelope, FaFacebook } from 'react-icons/fa';
...
// Updated inline styles for dark theme
...
const styles = {
  ...
  skillCard: {
    ...
    padding: '1rem',
    textAlign: 'center',
    backgroundColor: '#495057', // Darker card background
    borderRadius: '0.5rem',
  ...
  skillCardHover: {
    transform: 'scale(1.1)',
    backgroundColor: '#6c757d', // Slightly lighter on hover
  ...
  aboutMeSection: {
    ...
    margin: 'auto',
    padding: '2rem',
    backgroundColor: '#495057', // Darker section background
    borderRadius: '0.5rem',
...
const footerStyles = {
  container: {
    backgroundColor: '#212529', // Dark footer background
    color: '#ffffff', // Light text color
    padding: '2rem 0',
    textAlign: 'center',
  },
  ...
  socialIconsHover: {
    color: '#17a2b8', // Light teal color on hover
  },
  footerText: {
    margin: '1rem 0',
  },
  ...
  const projects = [
    {
      ...
      description: 'A comprehensive Real Estate Management System that allows users to list, search, and manage property listings. Built with React, Node.js, Express, and MongoDB.',
      link: 'https://github.com/your-repo/real-estate-management-system',
      gitLink: 'https://github.com/harshit14012006/projectrealestate',
      buttonColor: '#28a745', // Real estate-themed color (green)
      technologies: ['React', 'Node.js', 'Express', 'MongoDB']
    },
    {
      title: 'Static IT Website Layout',
      description: 'A modern and responsive static website layout designed for an IT company. Built using React and Tailwind CSS with a focus on clean design and smooth user experience.',
      link: 'https://github.com/your-repo/static-it-website-layout',
      gitLink: 'https://github.com/harshit14012006/sst_static',
      buttonColor: '#28a745', // IT-themed color (blue)
    ...
    <div style={{ marginTop: '20px', display: 'flex', justifyContent: 'center' }}>
      <div style={{ display: 'flex', alignItems: 'center' }}>
        <a
          ...
          style={{ 
            ...
            alignItems: 'center', 
            textDecoration: 'none', 
            color: '#f5f5f5' // Lighter color for better visibility
          }}
        >
          <FaGithub size={20} style={{ marginRight: '5px', color: '#4078c0' }} /> {/* Custom color for GitHub icon */}
          GitHub
        </a>
        <a
          href="/"
          ...
          style={{ 
            ...
            alignItems: 'center', 
            textDecoration: 'none', 
            color: '#0077b5' // LinkedIn standard color
          }}
        >
      ...
      <Row className="mb-5" data-aos="fade-up">
        <Col xs={12} style={styles.aboutMeSection}>
          ...
          <Card className="bg-dark text-light mx-auto" style={styles.sectionCard}>
            <Card.Body>
              <Card.Text>
                I am a passionate web developer with a strong foundation in both frontend and backend technologies. My expertise lies in crafting seamless user experiences, and I am always eager to learn new tools and techniques to enhance my skills. I believe in clean, maintainable code and strive to follow best practices in all my projects. Let's connect and build something great together!
              </Card.Text>
            </Card.Body>
          </Card>
        </Col>
          ...
          <Row>
            {[
              ...
              >
                ...
                >
                  <img src={skill.image} alt={skill.label} style={styles.skillImage} />
                  ...
                  <Row className="text-center">
                    <Col>
                      <Button
                        ...
                        onMouseLeave={(e) => {
                          e.currentTarget.style.backgroundColor = project.buttonColor;
                          e.currentTarget.style.borderColor = project.buttonColor;
                        }}
                      >
      ...
      {[
        {
          ...
          timeSpan: '2023 July - Present', // Time span for the experience
        },
      ].map((experience, index) => (
        <Col xs={12} md={8} className="mb-4" key={index}>
          <Card className="bg-dark text-light" style={styles.sectionCard}>
            <Card.Body className="d-flex flex-column flex-md-row align-items-center">
              <FaFileCode size={50} style={{ marginRight: '1rem', color: '#007bff' }} />
              <div>
                ...
                <Card.Text>
                  <small style={{ color: '#adb5bd' }}>{experience.timeSpan}</small>
                </Card.Text>
              </div>
            </Card.Body>
          </Card>
...
<Row className="mb-5 text-center" data-aos="fade-up">
        <Col>
          ...
          <p>If you are interested in collaborating or just want to say hi, feel free to reach out to me through any of the platforms below.</p>
          <Button
  ...
  onMouseEnter={(e) => {
    e.currentTarget.style.backgroundColor = '#218838'; // Darker green on hover
    e.currentTarget.style.borderColor = '#218838'; // Darker green on hover
  }}
  onMouseLeave={(e) => {
    e.currentTarget.style.backgroundColor = '#28a745'; // Reset to original green
    e.currentTarget.style.borderColor = '#28a745'; // Reset to original green
  }}
>
  Email Me
</Button>
    ...
    <Col>
      ...
      <div>
        <a
          ...
          onMouseEnter={(e) => (e.currentTarget.style.color = footerStyles.socialIconsHover.color)}
          onMouseLeave={(e) => (e.currentTarget.style.color = footerStyles.socialIcons.color)}
        >
  ...
  <Row>
    <Col>
      <p style={footerStyles.footerText}>
        &copy; {new Date().getFullYear()} Harshit Singla. All rights reserved.
      </p>
    </Col>
  </Row>
</Container>
