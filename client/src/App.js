...
const App = () => {
  ...
  return (
    <div className="font-sans text-gray-100">
      ...
      <header
        id="home"
        className="flex flex-col items-center justify-center min-h-screen px-6 py-20 text-center bg-gradient-to-b from-gray-900 to-gray-800 md:ml-20"
      >
      ...
      <section
        id="skills"
        className="px-8 py-16 text-center bg-gradient-to-b from-gray-800 to-black md:ml-20"
      >
      ...
      <section
      id="projects"
      className="px-6 py-20 bg-gradient-to-b from-black to-gray-900 md:ml-20"
    >
      <div className="max-w-6xl mx-auto">
        ...
        >
          {projects.map((project, index) => (
            <SwiperSlide key={index}>
              <div className="flex flex-col items-center overflow-hidden bg-gray-800 rounded-lg shadow-xl transform transition-transform duration-300 hover:scale-105 md:flex-row h-[350px]">
                {/* Left Side - Image */}
                ...
                <div className="flex flex-col justify-between h-full p-8 space-y-4 md:w-2/3">
                  ...
                  <div className="mt-auto">
                    <a
                      href="/"
                      className="inline-block px-6 py-3 text-sm font-medium text-white transition transform bg-indigo-600 rounded-lg shadow-md hover:bg-indigo-700 hover:scale-105"
                    >
                      View Project
                    </a>
                  </div>
        ...
        <div className="flex justify-center mt-6 space-x-4">
          <button
            ...
            className="px-6 py-3 text-sm font-medium text-white bg-gray-800 rounded-lg shadow-md hover:bg-gray-700"
          >
            Previous
          </button>
          <button
